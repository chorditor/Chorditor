// ── React Native ES Module version of chord-voicings.js ──
// chordNoteName must be defined before CHORD_PATTERN arrow functions are called
const _PCS = [4, 9, 2, 7, 11, 4];
const _S   = ['C','C#','D','D#','E','F','F#','G','G#','A','A#','B'];
const _F   = ['C','Db','D','Eb','E','F','Gb','G','Ab','A','Bb','B'];
export function chordNoteName(si, fret, flat = false) {
