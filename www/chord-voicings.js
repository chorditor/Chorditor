...
window.CHORD_PATTERN = [
  ...
  { pattern: 'x x r+1 r+2 x r+2', rootStr: 4, fingers: 'x x 1 2 x 3', barre: false, quality: 'dim', name: (r, flat) => chordNoteName(2, r+1, flat) + 'dim'},
  ...
  { pattern: 'x r+3 r+2 r+3 r+1 x', rootStr: 5, fingers: 'x 3 2 4 1 x', barre: true, quality: '7', name: (r, flat) => chordNoteName(1, r+3, flat) + '7'},
