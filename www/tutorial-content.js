  ...
  <div class="tutorial-section-block">
    ...
    <div class="tutorial-update-body">
      <div class="tutorial-update-content">
        ...
        <p class="tutorial-update-text">&nbsp;노트를 만드셨다면 (혹은 만드실 때) 에디터에서 작성한 코드를 그대로 노트로 가져올 수 있습니다. 노트에서도 편집 시 언제든지 에디터로 수정할 수 있습니다.</p>
        ...
        <h4 class="tutorial-section">노트</h4>
        ...
        <p class="tutorial-update-text">&nbsp;텍스트에 노래 가사 또는 코드 설명을 작성해서 자유롭게 활용하시면 됩니다. 이렇게 만든 노트는 공유 코드로 지인들과 공유할 수 있습니다. <br><br>&nbsp;단, 제목이나 텍스트 내용은 공유되지 않습니다. 노래 저작권 문제로 해당 내용은 공유에서 제외됩니다. (앞으로 코디터가 성장해서 저작권을 취득하고 더욱 풍성한 콘텐츠를 제공할 수 있도록 여러분의 많은 관심 부탁드립니다!)</p>
